...
public class PaginatedObservableCollection<T> : ObservableCollection<T>
{
    ...
    public void ForceRaiseChanged()
    {
        NotifyCollectionChangedEventArgs foo = new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset);
        OnCollectionChanged(foo);
    }
